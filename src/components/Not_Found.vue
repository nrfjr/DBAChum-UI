<template>
    <div class="not-found flex justify-center font-bold h-screen text-white">
        <div class="flex flex-col justify-center">
            <div class="grid grid-cols-2 grid-rows-3 gap-2 content-center h-min">
                <div class="text-6xl font-sans">(ᴗ_ ᴗ。)</div>
                <div class="col-start-1 row-start-2 text-lg mt-2 font-normal text-start">
                    <p>Your page being requested cannot be found.</p>
                    <p>We need to find the working page.</p>
                    <p>Then lets start to load from there with you.</p>
                </div>
                <div class="col-start-1 row-start-3 flex justify-start gap-2 mt-4">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g transform="translate(62,62)">
                            <g transform="translate(310,0) scale(0.31,0.31)">
                                <g transform="" style="fill: rgb(0, 120, 215);">
                            ...
                            <g transform="translate(930,744) scale(0.31,0.31)">
                                <g transform="" style="fill: rgb(0, 120, 215);">
                                    <rect width="100" height="100" />
                                </g>
                            </g>
                    ...
                    <div class="flex flex-col text-[12px] font-thin text-start">
                        <p>For more info abot this issue and possible fixes,</p>
                        <p>please visit: <a href="http://www.youtube.com/watch?v=5wOXc03RwVA?autoplay=1" target="_blank">https://www.windows.com/stopcode</a></p>
                        <p class="mt-4 text-[8px]">If you call a support person, give them this info:</p>
                        <p class="text-[10px]">Stop code: CRITICAL_PAGE_DIED</p>
                    </div>
                </div>
                <div class="row-span-3 col-start-2 row-start-1 flex flex-col justify-end">
                    <img class="empty-cat h-18" alt="idle spinning cat" title="matthew" />
                </div>
            </div>
        </div>
    </div>
